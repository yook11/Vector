...
echo "Created Postgres app roles (vector_auth, vector_app, vector_collect, vector_outbox_relay, vector_auth_rate_limit_cleanup, vector_article_analysis) — GRANT applied via alembic migration."
