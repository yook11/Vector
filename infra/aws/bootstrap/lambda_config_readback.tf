...
locals {
  lambda_config_function_arns = concat(values(local.backfill_lambda_arns), [local.outbox_lambda_arn, local.embedding_consumer_lambda_arn, local.assessment_outbox_relay_lambda_arn, local.assessment_consumer_lambda_arn, local.curation_consumer_lambda_arn, local.curation_outbox_relay_lambda_arn, local.completion_consumer_lambda_arn, local.completion_outbox_relay_lambda_arn])
