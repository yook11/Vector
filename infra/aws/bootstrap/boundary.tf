...
resource "aws_iam_policy" "outbox_relay_lambda_boundary" {
  name        = "${var.name_prefix}-outbox-relay-lambda-boundary"
  path        = "/${var.name_prefix}-ci/"
...
resource "aws_iam_policy" "outbox_relay_scheduler_boundary" {
  name        = "${var.name_prefix}-outbox-relay-scheduler-boundary"
  path        = "/${var.name_prefix}-ci/"
