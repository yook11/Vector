...
- assessment: `terminal_stage_blocked` / `terminal_target_rejected` /
  `terminal_classification_unresolved` / `recoverable`
- embedding: `terminal_stage_blocked` / `terminal_target_rejected` / `recoverable`
