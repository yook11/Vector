...
export function PaperNewsControls() {
  ...
  return (
    <div
      className="flex flex-wrap items-center gap-x-4 gap-y-2 text-[12px] tracking-[0.06em] text-[var(--vector-ink-muted)]"
      style={{ fontFamily: "var(--font-vector-maru)" }}
    >
      <div className="inline-flex items-center gap-2">
        <span className="text-[11.5px] tracking-[0.04em] text-[var(--vector-ink-muted)]">
          並び替え
        </span>
        <Select
