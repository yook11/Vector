...
export type StreamResearchRunEventsData = {
    body?: never;
    headers?: {
        /**
         * Last-Event-Id
    ...
    query?: never;
    url: '/api/v1/research/runs/{run_id}/events';
};

export type StreamResearchRunEventsErrors = {
    /**
     * Malformed run ID or Last-Event-ID
     */
    400: unknown;
    /**
     * Not authenticated
    ...
    422: HttpValidationError;
    /**
     * Run or user connection limit exceeded
     */
    429: unknown;
    /**
     * Live delivery is temporarily unavailable
     */
    503: unknown;
};

export type StreamResearchRunEventsError = StreamResearchRunEventsErrors[keyof StreamResearchRunEventsErrors];

export type StreamResearchRunEventsResponses = {
    /**
     * SSE channel started
     */
    200: unknown;
...
export type StreamResearchRunEventsResponse = StreamResearchRunEventsResponses[keyof StreamResearchRunEventsResponses];
