...
| 部分 | 現行 | 新 |
|---|---|---|
| JSON フィールド順 | title_ja → summary_ja → reasoning | **category → topic →** title_ja → summary_ja → reasoning |
...
3. 既存フィールド (`title_ja`, `summary_ja`, `reasoning`): 現行と同じ
