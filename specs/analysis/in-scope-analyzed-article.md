...
- `InScopeCategory` は in-scope category 12 値の SSoT であり、AI schema 用の全 category 値は [`assessment-category-taxonomy.md`](./assessment-category-taxonomy.md) で定義する `assessment_category_values()` が合成する。
