...
管理者専用のサブルーター (sources / source_health / pipeline / pipeline_health) を
...
from app.admin.source_health.router import router as source_health_router
...
admin_router.include_router(source_health_router)
