"""ITmedia AI+ 用 Source (本文は HTML 必須)。
...
class ITmediaAISource:
    """ITmedia AI+ 用 ``XxxSource`` (Pattern H、body 不信用)。"""

    name: ClassVar[SourceName] = SourceName("ITmedia AI+")
    endpoint_url: ClassVar[str] = "https://rss.itmedia.co.jp/rss/2.0/aiplus.xml"
