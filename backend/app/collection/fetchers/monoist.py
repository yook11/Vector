"""MONOist 用 Fetcher — Pattern H (RSS で URL 列挙、本文は HTML 必須)。
...
旧 ``fetchers/rss/monoist.py`` (BaseRssFetcher 継承の薄スタブ) は本 PR で
