"""``GeminiExtractor._translate_error`` の Stage 3 specific 翻訳テスト。

Stage 3 が translator delegation 前に挟む独自分岐:

- Pydantic ``ValidationError`` → ``ExtractionResponseInvalidError`` (Layer 2-B)
...
# ---------------------------------------------------------------------------
# Stage 3 specific: ValidationError → ExtractionResponseInvalidError
# ---------------------------------------------------------------------------
