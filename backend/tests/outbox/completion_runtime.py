"""実補完 relayのDB署名とSQS通信だけをローカルへ接続する。"""
...
COMPLETION_QUEUE_URL = (
    "https://sqs.ap-northeast-1.amazonaws.com/123456789012/article-completion"
)


def configure_completion_relay(monkeypatch, database_url):
    ...
    for name, value in {
        ...
        "SQS_ARTICLE_COMPLETION_QUEUE_URL": COMPLETION_QUEUE_URL,
    }.items():
