...
def _runner(
    *,
    ...
    phases = AnsweringPhases(
        ...
        reviewer=EvidenceReviewService(agent=EVIDENCE_REVIEWER_AGENT, runtime_scope_factory=factory.reviewer_scope),
...
async def test_direct_path_run_span_has_no_evidence_count_attributes(
    ...
    phases = AnsweringPhases(
        ...
        reviewer=EvidenceReviewService(agent=EVIDENCE_REVIEWER_AGENT, runtime_scope_factory=_UnreachableExternalScope()),
        organizer=PassThroughOrganizer(),
    )
